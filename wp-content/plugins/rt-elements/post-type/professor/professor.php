...
$professor_label = !empty($redux_value['professors_label_text']) ? $redux_value['professors_label_text'] : esc_html__('Professor', 'rtelements');
$professor_label_plural = $professor_label . 's'; // You can also make this a separate Redux option if needed
$labels = array(
    'name'               => esc_html( $professor_label_plural ),
    'singular_name'      => esc_html( $professor_label ),
    'add_new'            => sprintf( esc_html__( 'Add New %s', 'rtelements' ), $professor_label ),
    'add_new_item'       => sprintf( esc_html__( 'Add New %s', 'rtelements' ), $professor_label ),
    'edit_item'          => sprintf( esc_html__( 'Edit %s', 'rtelements' ), $professor_label ),
    'new_item'           => sprintf( esc_html__( 'New %s', 'rtelements' ), $professor_label ),
    'all_items'          => sprintf( esc_html__( 'All %s', 'rtelements' ), $professor_label_plural ),
    'view_item'          => sprintf( esc_html__( 'View %s', 'rtelements' ), $professor_label ),
    'search_items'       => sprintf( esc_html__( 'Search %s', 'rtelements' ), $professor_label ),
    'not_found'          => sprintf( esc_html__( 'No %s found', 'rtelements' ), $professor_label ),
    'not_found_in_trash' => sprintf( esc_html__( 'No %s found in Trash', 'rtelements' ), $professor_label ),
    'parent_item_colon'  => sprintf( esc_html__( 'Parent %s:', 'rtelements' ), $professor_label ),
    'menu_name'          => esc_html( $professor_label_plural ),
);
...
function reactheme_tr_create_team() {
    ...
    register_taxonomy(
        ...
        'teams',
        array(
            'label'             => sprintf( esc_html__( '%s Categories', 'rtelements' ), $professor_label ),
            'hierarchical'      => true,
