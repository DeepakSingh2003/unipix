...
class Reactheme_Image_Showcase_Widget extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        $image_rotate =  ( !empty($settings['image_animation_rotate']) && $settings['image_animation_rotate'] === 'yes' ) ? 'image-rotate' : '';
        ?>
        <?php 
        if($settings['img_select_type'] == 'jarallax') { ?>
            ...
            <div class="react-image <?php echo esc_attr($settings['image_animation']); ?>">
                <?php if(!empty($settings['first_image']['url'])) : ?>
                    <img class="react-multi-image <?php echo esc_attr($settings['images_translate']); ?> <?php echo esc_attr($image_rotate);?> " src="<?php echo esc_url($settings['first_image']['url']);?>" alt="<?php echo esc_attr($settings['first_image']['alt']); ?>"/>
                <?php endif; ?>
            </div>
        <?php 
