            ...
            <div class="row g-5">
                <div class="col-lg-7 col-md-6">
                    <div class="category-search">
                        ...
                        <form action="#" class="cat-search-form" onsubmit="return false;">
                            <input type="text" placeholder="<?php echo esc_attr($settings['search_placeholder']); ?>" name="s" id="cat">
                            <button type="button" class="cat-search"><?php \Elementor\Icons_Manager::render_icon( $settings['search_icon'], [ 'aria-hidden' => 'true' ] ); ?></button>
                        </form>
                    </div>
                </div>
			...
			<script>
				(function ($) {
					$(document).ready(function () {
                        ...
                        $('.cat-search-form').on('submit', function(e) {
                            e.preventDefault();
                            return false;
                        });
                        ...
                        $('.cat-search').on('click', function(e) {
                            e.preventDefault();
                            $('.search-filter .category-search .cat-search-form input').trigger('keyup');
                        });
