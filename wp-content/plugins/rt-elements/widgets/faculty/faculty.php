      ...
      $this->start_controls_section(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rts__program--item--title' => 'color: {{VALUE}};',                   
                ],                
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rts__program--item--title:hover' => 'color: {{VALUE}};',                                      
                ],                
            ]            
        );
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rts__program--item--title',                    
			]
		);				
		$this->add_responsive_control(
			'title_margin',
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .rts__program--item--title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rts__program--item--description' => 'color: {{VALUE}};',                   
                ],                
            ]
        );
        $this->add_group_control(
			...
			[
				'name' => 'des_typography',
				'label' => esc_html__( 'Typography', 'rtelements' ),				
				'selector' => '{{WRAPPER}} .rts__program--item--description',                    
			]
		);		
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rts-nbg-btn svg' => 'fill: {{VALUE}};',                   
                ],                
            ]
        );
        $this->add_group_control(
