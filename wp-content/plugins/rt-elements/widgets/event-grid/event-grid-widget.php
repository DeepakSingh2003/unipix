...
class Reactheme_Elementor_Events_Grid_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {	
		...
		$this->add_control(
			'course_per',
			[
				'label' => esc_html__( 'Event Per Page', 'rtelements' ),
		...
		$this->start_controls_section(
			'cate_section',
			[
				'label' => esc_html__( 'Category Settings', 'rtelements' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			'lock_section',
			[
				'label' => esc_html__( 'Address Settings', 'rtelements' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			'time_section',
			[
				'label' => esc_html__( 'Time Settings', 'rtelements' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
