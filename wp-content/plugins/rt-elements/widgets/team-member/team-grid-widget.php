...
class ReacTheme_Elementor_Team_Grid_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
      ...
      $this->add_control(
		...
		$this->start_controls_section(
			'section_content_share_style',
			[
				'label' => esc_html__( 'Share Button', 'rsaddon' ),
				'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
					'team_grid_source' => 'dynamic',
		...
		$this->add_control(
			...
			[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [                           
						'{{WRAPPER}} .share-btn' => 'color: {{VALUE}} !important;',                              
					],                
			]
		);
		$this->add_control(
			...
			[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [                           
						'{{WRAPPER}} .share-btn:hover' => 'color: {{VALUE}};',                              
					],                
			]
		);
		$this->add_control(
			...
			[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [                           
						'{{WRAPPER}} .share-btn' => 'background: {{VALUE}};',                              
					],                
			]
		);
		$this->add_control(
			...
			[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [                           
						'{{WRAPPER}} .share-btn:hover' => 'background: {{VALUE}};',                              
					],                
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [                           
						'{{WRAPPER}} .team_social a' => 'color: {{VALUE}} !important;',                              
					],                
			]
		);
		$this->add_control(
			...
			[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [                           
						'{{WRAPPER}} .team_social a:hover' => 'color: {{VALUE}} !important;',                              
					],                
			]
		);
		$this->add_control(
			...
			[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [                           
						'{{WRAPPER}} .team_social a' => 'background: {{VALUE}};',                              
					],                
			]
		);
		$this->add_control(
			'social_hover_bgcolor',
			[
					'label' => esc_html__( 'Hover Background', 'rtelements' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [                           
						'{{WRAPPER}} .team_social a:hover' => 'background: {{VALUE}};',                              
					],                
			]
		);
		$this->end_controls_section();
