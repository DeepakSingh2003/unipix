...
class Rsaddon_Elementor_pro_Marquee_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
			'mid_gap',
			[
				'label' => esc_html__( 'Title & Icon (Gap)', 'rtelements' ),
				...
				'selectors' => [
					'{{WRAPPER}} .single__marque__item__list__text' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .single__marque__item' => 'background: {{VALUE}}',
				],
			]
		);
        $this->add_responsive_control(
			'item_height',
			[
				'label' => esc_html__( 'Item Height', 'rtelements' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .single__marque__item' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
        $this->add_control(
            'before_background_desc',
            [
                'type' => \Elementor\Controls_Manager::RAW_HTML,
                'raw' => esc_html__( 'Change the left overlay color below in the background settings.', 'rtelements' ),
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .single__marque__item::before',
			]
		);
        
        $this->add_control(
            'after_background_desc',
            [
                'type' => \Elementor\Controls_Manager::RAW_HTML,
                'raw' => esc_html__( 'Change the right overlay color below in the background settings.', 'rtelements' ),
                'content_classes' => 'elementor-descriptor',
            ]
        );
        $this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .single__marque__item::after',
                'description' => esc_html__( 'Right overlay color changes here.', 'rtelements' ),
			]
		);
        $this->end_controls_section();        
    }
