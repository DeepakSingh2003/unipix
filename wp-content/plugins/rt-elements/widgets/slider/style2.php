...
<div class="swiper-slide">
    <div class="single-testimonial slider_item">
        <?php 
        if( !empty( $settings['quote_icon']['value'] || $item['show_rating'] == 'yes') ) : ?>
            <div class="rt-between mb--50">
                ...
                if( !empty( $item['rating_text'] || $item['rating_unmber'] ) && $item['show_rating'] == 'yes' ) : ?>
                    <div class="rt-review">
