...
if ( is_plugin_active('the-events-calendar/the-events-calendar.php') ) { 
	...
	?>
	<div class="rt-event col-lg-<?php echo esc_html($settings['portfolio_columns']);?> col-md-<?php echo $settings['col_md']; ?> col-sm-<?php echo $settings['col_sm']; ?> grid-item <?php echo $termsString;?>">
		<div class="single-event event_item">
			<div class="event single-event__content">
				<?php if ( has_post_thumbnail($event->ID) ) : ?>
                    <div class="event__thumb rts__single--event--thumb">
