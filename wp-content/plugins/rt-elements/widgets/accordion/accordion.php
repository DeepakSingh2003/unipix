...
class ReacTheme_Widget_Accordion extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
			...
			[
				'name' => 'item_border',
				'selector' => '{{WRAPPER}} .rts-accordion.style1 .accordion-item',
			]
		);
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rts-accordion.style1 .accordion-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        ); 
        $this->add_responsive_control(
        ...
        $this->add_group_control(
			...
			[
				'name' => 'des_typo',
				'selector' => '{{WRAPPER}} .rts-accordion.style1 .accordion-item .accordion-body',
			]
		);
        $this->add_group_control(
