...
class Reactheme_Button_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [					
					...
					'btn_style5' => esc_html__( 'Button 5', 'rtelements')
				],
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,		      
		        'selectors' => [
		            '{{WRAPPER}} .react_button span' => 'background: {{VALUE}};',
		        ],
		    ]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
		    ...
		    [
		      ...
		      'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'selectors' => [		      		            
					'{{WRAPPER}} .react_button span' => 'line-height: {{SIZE}}{{UNIT}};',		            
				],
		    ]
		);	
		$this->end_controls_section();
	...
	?>	
		...
		if($settings['button_style'] == 'primary_btn'):?>
			<a <?php echo esc_attr($target); ?> aria-label="button" class="react_button" href="<?php echo esc_url($settings['btn_link']['url']);?>">	
		...
		elseif($settings['button_style'] == 'default_btn') : ?>
			<a <?php echo esc_attr($target); ?> aria-label="button" class="react_button <?php echo esc_attr($settings['button_style']); ?>" href="<?php echo esc_url($settings['btn_link']['url']);?>">	
				<?php echo esc_html($settings['btn_text']);?>
				<?php if (!empty($settings['btn_icon']['value'])) : ?>
					<span>
						<?php \Elementor\Icons_Manager::render_icon($settings['btn_icon'], ['aria-hidden' => 'true']); ?>
		...
		elseif($settings['button_style'] == 'transparent_btn') : ?>
			...
			<?php 
		elseif($settings['button_style'] == 'btn_style5') : ?>
			<a <?php echo esc_attr($target); ?> aria-label="button" class="react_button <?php echo esc_attr($settings['button_style']); ?>" href="<?php echo esc_url($settings['btn_link']['url']);?>">	
				<?php echo esc_html($settings['btn_text']);?>
				<?php if (!empty($settings['btn_icon']['value'])) : ?>
					<span>
			...
			<a <?php echo esc_attr($target); ?> <?php echo esc_attr($target); ?> aria-label="button" class="react_button <?php echo esc_attr($settings['button_style']); ?>" href="<?php echo esc_url($settings['btn_link']['url']);?>">	
				<?php echo esc_html($settings['btn_text']);?>
				<?php if (!empty($settings['btn_icon']['value'])) : ?>
					<span>
						<?php \Elementor\Icons_Manager::render_icon($settings['btn_icon'], ['aria-hidden' => 'true']); ?>
