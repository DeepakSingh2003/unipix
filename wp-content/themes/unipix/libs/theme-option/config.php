...
Redux::setSection( $opt_name, array(
    ...
    'fields'           => array(       
        ...
        array(
            'id'       => 'professors_label_text',
            'type'     => 'text',
            'title'    => __('Professors Admin Menu', 'unipix'),
            'default'  => 'Porfessors'
        ),
        array(
            'id'       => 'team_slug',                               
...
Redux::setSection( $opt_name, array(
    ...
    'fields'           => array( 
        ...
        array(
            'id'       => 'faculty_label_text',                               
            'title'    => esc_html__( 'Faculty Admin Menu', 'unipix' ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'           => array(     
        array(
            'id'       => 'department_label_text',
            'type'     => 'text',
            'title'    => __('Department Admin Menu', 'unipix'),
            'default'  => 'Department'
        ),
        array(
            'id'       => 'department_slug',                               
    ...
    array(
        ...
        'fields'           => array(
            ...
            array(
                'id'      => 'blog-description',
                'type'    => 'switch',
                'title'   => esc_html__('Show Excerpt', 'unipix'),
                'desc'    => esc_html__('You can show/hide excerpt at blog page', 'unipix'),
                'default' => true,
            ),

            array(
                'id'      => 'blog_readmore_show',
                'type'    => 'switch',
                'title'   => esc_html__('Show Read More', 'unipix'),
                'desc'    => esc_html__('You can show/hide readmore at blog page', 'unipix'),
                'default' => true,
            ),
    ...
    array(
        ...
        'fields'           => array(
            ...
            array(
                'id'               => 'featured_show',
                'type'             => 'select',
                'title'            => esc_html__('Featured Image Show/Hide Only Single Posts', 'unipix'),
                'desc'             => esc_html__('Select featured image show or hide', 'unipix'),
                'options'          => array(
                    'show'             => esc_html__('Show', 'unipix'),
                    'hide'             => esc_html__('Hide', 'unipix'),
                ),
            ...
            array(
                'id'               => 'blog-author-post-single',
                'type'             => 'select',
                'title'            => esc_html__('Show Author ', 'unipix'),
                'desc'             => esc_html__('Select author show or hide', 'unipix'),
                'options'          => array(
                    'show'             => esc_html__('Show', 'unipix'),
                    'hide'             => esc_html__('Hide', 'unipix'),
                ),
            ...
            array(
                'id'       => 'blog-author',
                'type'     => 'select',
                'title'    => esc_html__('Show Ahthor Bio', 'unipix'),
                'desc'     => esc_html__('Select author bio show or hide', 'unipix'),
                //Must provide key => value pairs for select options
                'options'  => array(
                    'show' => esc_html__('Show', 'unipix'),
                    'hide' => esc_html__('Hide', 'unipix'),
...
if (class_exists('WooCommerce')) {
    Redux::setSection(
        $opt_name,
        array(
            'title'  => esc_html__('Woocommerce', 'unipix'),
        ...
        array(
            ...
            'fields'           => array(
                array(
                    'id'       => 'wc_num_product',
                    'type'     => 'text',
                    'title'    => esc_html__('Number of Products Per Page', 'unipix'),
                    'default'  => '9',
                ),
                ...
                array(
                    ...
                    'type'     => 'text',
                    'title'    => esc_html__('Number of Products Per Row', 'unipix'),
                    'default'  => '3',
                ),
            )
        )
    ...
    Redux::setSection(
        $opt_name,
        array(
            'title'            => esc_html__('Shop Single', 'unipix'),
            'id'               => 'shop_single',
            'customizer_width' => '450px',
            'subsection' => true,
            'fields'           => array(
                array(
                    'id'               => 'shop_releted_product',
                    'type'             => 'select',
                    'title'            => esc_html__('Releted Products ', 'unipix'),
                    'desc'             => esc_html__('Select Releted Products show or hide', 'unipix'),
                    'options'          => array(
                        'show'             => esc_html__('Show', 'unipix'),
                        'hide'             => esc_html__('Hide', 'unipix'),
                    ),
                ...
                array(
                    ...
                    'type'     => 'text',
                    'title'    => esc_html__('Number of Releted Products in Product detail Page', 'unipix'),
                    'default'  => '3',
                    'required' => array( 'shop_releted_product', '=', 'show' ), // <-- condition
                ),
            )
        )
    );
    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                'id'       => 'des_404',
                'type'     => 'textarea',
                'title'    => esc_html__('Message', 'unipix'),
                'subtitle' => esc_html__('Enter text for 404 page', 'unipix'),
                'default'  => esc_html__('Enter Message Here', 'unipix')
            ),
