                    ...
                    <div class="page-content">
                       ...
                       <?php } 
                        ...
                        <p class="error-msg">
                            ...
                            <?php 
                            if (!empty($unipix_option['des_404'])) {
                                    echo esc_html($unipix_option['des_404']);
                            } else {
                                echo esc_html__("Sorry, we couldn't find the page you where looking for. We suggest that you return to homepage.", 'unipix'); 
                            }
                            ?>
                            </p>
